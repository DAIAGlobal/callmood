#!/usr/bin/env python
"""
CallMood - Complete System Test & Demo
...
# Asegurar import del paquete principal
...
def test_all_modules():
    ...
    print("\n" + "="*70)
    print("CallMood - SYSTEM VALIDATION TEST")
    print("="*70 + "\n")
    ...
    try:
        ...
        from daia.infrastructure.pipeline import ResourceManager, ConfigManager
    ...
    try:
        ...
        from daia.infrastructure.pipeline import DAIADatabase
    ...
    if tests_failed == 0:
        print("\n✅ ALL TESTS PASSED - CALLMOOD IS READY!")
        cleanup_test_db()
        return 0
    else:
