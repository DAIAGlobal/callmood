...
class PipelineOrchestrator:
    ...
    def __init__(self, config_path: str = "config.yaml", db_path: str | None = None):
        ...
        Args:
            ...
            db_path: URL de la base de datos (si None se usa env DATABASE_URL)
        """
        try:
            # Configuración
        ...
        try:
            ...
            db_url = db_path or os.getenv("DATABASE_URL", "postgresql://callmood:callmood@db:5432/callmood")
            self.db = DAIADatabase(db_url)
