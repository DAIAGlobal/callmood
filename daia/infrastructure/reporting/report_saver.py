...
def save_json_report(result: Dict[str, Any], output_dir: str = "reports") -> Optional[str]:
...
def save_text_report(result: Dict[str, Any], output_dir: str = "reports") -> Optional[str]:
    ...
    try:
        ...
        with filepath.open('w', encoding='utf-8') as handle:
            handle.write("=" * 80 + "\n")
            handle.write("DAIA 2.0 - REPORTE DE ANÁLISIS DE LLAMADA\n")
            handle.write("=" * 80 + "\n\n")
