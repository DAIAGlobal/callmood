...
def _ensure_runtime_dirs() -> None:
    ...
    for folder in ["audio_in", "reports", "analysis", "transcripts", "data"]:
        Path(folder).mkdir(parents=True, exist_ok=True)


def _parse_args(argv: List[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="DAIA Call Audit runner")
    parser.add_argument(
        "path",
